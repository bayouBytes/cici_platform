...
urlpatterns = [
    ...
    path('chef/ingredient/unit/add/', add_ingredient_unit, name='add_ingredient_unit'),
    path('chef/ingredient/unit/edit/<int:unit_id>/', edit_ingredient_unit, name='edit_ingredient_unit'),
    path('chef/ingredient/unit/delete/<int:unit_id>/', delete_ingredient_unit, name='delete_ingredient_unit'),
